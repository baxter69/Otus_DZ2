//
// KinopoiskUserVoteResponseItems.swift
//
...
public struct KinopoiskUserVoteResponseItems: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(kinopoiskId: Int? = nil, nameRu: String? = nil, nameEn: String? = nil, nameOriginal: String? = nil, countries: [Country]? = nil, genres: [Genre]? = nil, ratingKinopoisk: Double? = nil, ratingImbd: Double? = nil, year: String? = nil, type: ModelType? = nil, posterUrl: String? = nil, posterUrlPreview: String? = nil, userRating: Int? = nil) {
