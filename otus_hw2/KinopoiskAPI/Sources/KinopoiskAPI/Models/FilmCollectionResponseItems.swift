...
public struct FilmCollectionResponseItems: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(kinopoiskId: Int, nameRu: String? = nil, nameEn: String? = nil, nameOriginal: String? = nil, countries: [Country]? = nil, genres: [Genre]? = nil, ratingKinopoisk: Double? = nil, ratingImbd: Double? = nil, year: Int? = nil, type: ModelType? = nil, posterUrl: String? = nil, posterUrlPreview: String? = nil) {
